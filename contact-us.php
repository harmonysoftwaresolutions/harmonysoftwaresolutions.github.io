...
<body>
    ...
    <section id="contact-info">
        <div class="center">                
            <h2>Como llegar?</h2>
            <p class="lead">Puedes dirigirte a nuestra oficinas, o ponte en contacto con nosotros.</p>
        </div>
        <div class="gmap-area">
            <div class="container">
                <div class="row">
                        ...
                        <ul class="row">
                            <li class="col-sm-6">
                                <address>
                                    ...
                                    <p>Barrio, Bethesda C/sn <br>
                                    Santa Cruz - Bolivia</p>
                                    <p>Teléfono: +591 77883004 <br>
                                    Direccion Email:info@harmony.com</p>
                                </address>
    ...
    <section id="contact-page">
        <div class="container">
            <div class="center">        
                ...
                <p class="lead">Atenderemos su solicitud lo más pronto posible.</p>
            </div> 
